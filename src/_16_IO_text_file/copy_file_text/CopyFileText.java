...
public class CopyFileText {
    public static final String SOURCE_FILE = "src/_16_IO_text_file/copy_file_text/source.txt";
    public static final String TARGET_FILE = "src/_16_IO_text_file/copy_file_text/target.txt";
